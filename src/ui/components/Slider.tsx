...
export function Slider({
  ...
  const handlePointerMove = useCallback(
    ...
    [isInteracting, positionToValue, percentFromValue, onChange, fillPercent, rubberStretchPx, computeRubberStretch, step]
  );
  ...
  const handlePointerUp = useCallback(
    ...
    [isInteracting, positionToValue, percentFromValue, onChange, min, max, step, fillPercent, rubberStretchPx]
  );
    ...
    <div ref={wrapperRef} className="dialkit-slider-wrapper">
      ...
      >
        ...
        <motion.div
          ...
          style={{ background: fillBackground, width: fillWidth, transition: 'background 0.15s' }}
        />
